!(function () {
...
})()(
	{
		...
		2: [
				...
				;(a.start = function (t) {
					...
					this._firstTabbableElement
						? this.el.contains(document.activeElement) ||
						  t ||
						  (this._firstTabbableElement.focus(), (e = this._firstTabbableElement))
			...
			{ './helpers/TabManager': 3, './helpers/hideSiblingElements': 5, './helpers/showSiblingElements': 8 },
		],
		3: [
			function (t, e, i) {
				'use strict'
				...
				;(o.isFocusableElement = function (t, e, i) {
					return (
						...
						(n.nodeName[t.nodeName]
							? !t.disabled
							: !t.contentEditable || ((i = i || parseFloat(t.getAttribute('tabindex'))), !isNaN(i)))
					)
				}),
		...
		21: [
			function (t, e, i) {
				...
				function c(t) {
					null !== t &&
						((this.el = t), (this._bindings = {}), (this._delegateFuncs = {}), (this._eventEmitter = new r()))
				}
				;((n = c.prototype).on = function () {
					...
					(n.trigger = function (t, e, i, n) {
						...
						for ('string' == typeof e ? ((r = this._cleanStringData(e)), (o = i)) : ((o = e), i), s = 0; s < a; s++)
					...
					(n.destroy = function () {
						var t
						for (t in (this._triggerInternalEvent('willdestroy'), this.off(), this))
						...
						if (0 !== t.length) {
							if ('string' == typeof t[0] || null === t[0])
								return (
									...
									(i.events = t[0]),
									'string' == typeof t[1]
										? ((i.delegateQuery = t[1]), (i.callback = t[2]), (i.context = t[3]))
					...
					(n._registerDelegateFunc = function (t, e, i, n, r) {
						...
						return (
							...
							this._delegateFuncs[e][t].push({ func: n, context: r, delegateFunc: o }),
							o
						)
					}),
					...
					(n._unbindDelegateFunc = function (t, e) {
						for (var i, n, r = 0; this._delegateFuncs[e][t] && this._delegateFuncs[e][t][r]; )
							(i = this._delegateFuncs[e][t][r]),
								...
								this._off({ events: t, delegateQuery: e, callback: i.func, context: i.context }),
						...
						;(e = this._parseEventNames(e)).forEach(
							function (t, e, i, n, r) {
								this.has(r) || this._setListener(r),
									...
									this._triggerInternalEvent('willon', { evt: r, callback: t, context: i, delegateQuery: n }),
									this._eventEmitter.on(r, t, i),
									this._triggerInternalEvent('didon', { evt: r, callback: t, context: i, delegateQuery: n })
							}.bind(this, i, o, r, n)
						),
							(e = i = o = n = r = null)
					}),
					(n._off = function (t) {
						...
						if (void 0 !== e)
							(e = this._parseEventNames(e)).forEach(
								function (t, e, i, n, r) {
									;('string' != typeof n || 'function' != typeof e || (t = this._unregisterDelegateFunc(r, n, e, i))) &&
										('string' != typeof n || void 0 !== t
											? ('string' == typeof r &&
													void 0 === t &&
													(this._unregisterDelegateFuncsByEvent(r), 'string' == typeof n)) ||
											  (this._triggerInternalEvent('willoff', { evt: r, callback: t, context: i, delegateQuery: n }),
											  this._eventEmitter.off(r, t, i),
											  this._triggerInternalEvent('didoff', { evt: r, callback: t, context: i, delegateQuery: n }),
						...
						;(e = this._parseEventNames(e)).forEach(
							function (t, e, i, n) {
								...
								this.has(n) || this._setListener(n),
									this._triggerInternalEvent('willonce', { evt: n, callback: t, context: e, delegateQuery: i }),
									this._eventEmitter.once.call(this, n, t, e),
									this._triggerInternalEvent('didonce', { evt: n, callback: t, context: e, delegateQuery: i })
							}.bind(this, i, r, n)
						),
							(e = i = n = r = null)
					}),
					(n._handleDelegateOnce = function (t, e, i, n) {
						return (
							this._triggerInternalEvent('willonce', { evt: t, callback: e, context: i, delegateQuery: n }),
							this._on({
								events: t,
								context: i,
								delegateQuery: n,
							...
							this._triggerInternalEvent('didonce', { evt: t, callback: e, context: i, delegateQuery: n }),
							this
						)
					}),
					...
					o = function (t, e) {
						;(this._domEmitter = e),
							...
							this._isDOMEvent(this.originalEvent)
								? 'object' == typeof this.originalEvent.detail && (this.data = this.originalEvent.detail)
								: t && ((this.data = this.originalEvent), (this.originalEvent = {}))
					}
				;((n = o.prototype).preventDefault = function () {
					...
					(n._isDOMEvent = function (t) {
						return !!(
							...
							('undefined' !== document.createEvent && 'undefined' != typeof CustomEvent && t instanceof CustomEvent)
						)
					}),
					(e.exports = o)
			},
			...
			function (t, e, i) {
				...
				t('@marcom/ac-polyfills/CustomEvent'),
					(e.exports = function (t, e, i) {
						...
						return (
							t.dispatchEvent
								? ((n = i ? new CustomEvent(e, i) : new CustomEvent(e)), t.dispatchEvent(n))
		...
		51: [
			...
			{ './internal/validate': 49, './shims/querySelectorAll': 53, '@marcom/ac-polyfills/Array/prototype.slice': 85 },
		],
		52: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				e.exports = function (t, e) {
					...
					for (
						...
						(i = document[c].shift()).style.removeAttribute('ac-qsa'), -1 === l.indexOf(i) && s(i, e) && l.push(i)
		...
		57: [
			function (t, e, i) {
				...
				var n = 'EventEmitter:propagation',
					...
					s = function () {
						return (
							this.hasOwnProperty('_events') || 'object' == typeof this._events || (this._events = {}), this._events
						)
					},
					a = function (t, e) {
						var i = t[0],
					...
					c = function (t, e) {
						...
						if ((i = s.call(this)[t]) && 0 !== i.length)
							for (
								i = i.slice(), this._stoppedImmediatePropagation = !1, n = 0, r = i.length;
				...
				;(o.on = function () {
					...
					return (
						a.call(this, arguments, function (e, i, n) {
							;(t[e] = t[e] || (t[e] = [])), t[e].push({ callback: i, context: n })
						}),
						this
					)
				}),
			...
			function (t, e, i) {
				...
				function s(t) {
					...
					this[o] || (this[o] = this._getKeyCode()),
						(this.location =
							void 0 !== this.originalEvent.location ? this.originalEvent.location : this.originalEvent.keyLocation)
				}
				;(s.prototype = {
			...
			function (t, e, i) {
				...
				;(d.open = function () {
					...
					(d.close = function (t) {
						...
						if (this.opened) {
							if (
								t &&
								'click' === t.type &&
								((e = n.target(t)), (i = this.renderer.options.dataAttributes.close), !e.hasAttribute(i))
							)
								return
					...
					(d.removeKeyToClose = function (t) {
						...
						;-1 !== e && this._keysToClose.splice(e, 1), this._releaseKeyToClose(t)
					}),
					...
					(d._releaseKeyToClose = function (t) {
						...
						;-1 !== e && (s.offUp(t, this.close), this._attachedKeysToClose.splice(e, 1))
					}),
			...
			function (t, e, i) {
				...
				;(c.render = function () {
					...
					(c.appendContent = function (t, e) {
						o.isElement(t) &&
							(void 0 === arguments[1] ? this.contentElement.appendChild(t) : o.isElement(e) && e.appendChild(t))
					}),
		...
		69: [
			...
			{ '@marcom/ac-accessibility/CircularTab': 2, '@marcom/ac-event-emitter-micro': 54, '@marcom/ac-modal-basic': 63 },
		],
		70: [
			function (t, e, i) {
				'use strict'
		...
		71: [
			...
			{ '../Modal': 69, '@marcom/ac-classlist/add': 11, '@marcom/ac-modal-basic': 63 },
		],
		72: [
			function (t, e, i) {
				'use strict'
					...
					try {
						...
						Array.prototype.slice = function (e, i) {
							...
							if ((i < 0 && (c = s + i), (r = c - a) > 0))
								if (((o = new Array(r)), this.charAt)) for (n = 0; n < r; n++) o[n] = this.charAt(a + n)
						...
						: (function (t) {
								...
								if ('Element' in t) {
									var e = t.Element.prototype,
										...
										a = function (t) {
											for (
												var e = n.call(t.getAttribute('class') || ''), i = e ? e.split(/\s+/) : [], r = 0, o = i.length;
												r < o;
												r++
											)
												this.push(i[r])
		...
		88: [
			function (t, e, i) {
				...
				e.exports = function t(e, i) {
					...
					if (e in r) for (h = 0; h < r[e].length; h++) if (((c = r[e][h]), n(c.toLowerCase(), i))) return (l[e] = c)
					for (h = 0; h < s.evt.length; h++) if (((c = s.evt[h] + e), n(c, i))) return s.reduce(h), (l[e] = c)
		...
		90: [
			function (t, e, i) {
				...
				;(a.initialize = function () {
					...
					(a.reduce = function (t) {
						this.reduced ||
							((this.reduced = !0), (this.css = [this.css[t]]), (this.dom = [this.dom[t]]), (this.evt = [this.evt[t]]))
					}),
					(e.exports = new s())
			},
			{},
			...
			function (t, e, i) {
				...
				e.exports = function (t, e) {
					...
					return (
						...
						t in (i = n[e]) || ('setAttribute' in i && (i.setAttribute(t, 'return;'), 'function' == typeof i[t]))
					)
				}
			},
			{},
		...
		93: [
			...
			{ './ac-router/History': 94, './ac-router/Router': 95, '@marcom/ac-routes': 96 },
		],
		94: [
			function (t, e, i) {
				'use strict'
				...
				;(a._isRoot = function (t) {
					...
					(a._checkUrl = function () {
						...
						0 === t.length && (t = '/'),
							this.fragment() !== t &&
								((window.location.hash = '#' + t), (this._ignoreHashChange = !1), this._handleHashChange())
					}),
							...
							this.started ||
								...
								this._pushState
									? ((this._handlePopState = this._handlePopState.bind(this)),
									  r.addEventListener(window, 'popstate', this._handlePopState))
									: this._hashChange &&
									  (this._isHashChangeSupported()
											? ((this._handleHashChange = this._handleHashChange.bind(this)),
											  r.addEventListener(window, 'hashchange', this._handleHashChange))
					...
					(a.stop = function () {
						this.started &&
							((this.started = !1),
							this._pushState
								? r.removeEventListener(window, 'popstate', this._handlePopState)
								: this._hashChange &&
								  (this._isHashChangeSupported()
										? r.removeEventListener(window, 'hashchange', this._handleHashChange)
										: this._checkUrlInterval &&
										  (clearInterval(this._checkUrlInterval), (this._checkUrlInterval = null))))
					}),
						...
						return (
							this._pushState
								...
								: this._hashChange &&
								  ...
								  this._isHashChangeSupported() ||
										(this._iframe.document.open().close(), (this._iframe.location.hash = '#' + t))),
							!0
						)
					}),
					(a.fragment = function () {
			...
			{ '@marcom/ac-dom-events': 25, '@marcom/ac-event-emitter': 56, '@marcom/ac-object': 72 },
		],
		95: [
			function (t, e, i) {
				'use strict'
				...
				function a(t) {
					;(t = t || {}),
						...
						t.autoStart && (this.history.started || this.history.start(), this.start())
				}
				...
				;(c._handleTrigger = function (t) {
					if (this.started) {
						...
						e &&
							(/^(http|https):\/\/+/.exec(e) &&
								...
								(e = e.substr(e.indexOf(this.history.root) + this.history.root.length) || '/'),
					...
					(c.stop = function () {
						this.started &&
							((this.started = !1), this.history.stop(), this.history.off('popstate', this._handlePopstate))
					}),
			...
			{ './History': 94, '@marcom/ac-dom-emitter': 20, '@marcom/ac-object': 72, '@marcom/ac-routes': 96 },
		],
		96: [
			function (t, e, i) {
				'use strict'
					...
					(o.match = function (t) {
						...
						for (e in this._routes)
							for (
								...
								--i > -1 && (!this._routes[e][i].match(t) || !this._routes[e][i].greedy);
					...
					if (t) {
						...
						n.forEach(function (e, n) {
							var o = t[e],
								s =
									(e = e.trim()) +
									(o = null === (o = o && 'string' == typeof o ? o.trim() : o) ? '' : '=' + o) +
									(n === r ? '' : '&')
							i = i ? i.concat(s) : s
						})
					}
		...
		102: [
			...
			{ './isDesktop': 101, './isTablet': 104, '@marcom/function-utils/once': 106 },
		],
		103: [
			function (t, e, i) {
				'use strict'
		...
		104: [
			...
			{ './helpers/globals': 100, './isDesktop': 101, '@marcom/function-utils/once': 106 },
		],
		105: [
			function (t, e, i) {
				'use strict'
				...
				e.exports = {
					...
					os: [
						...
						},
						{
							...
							test: function (t) {
								return (
									(t.ua.indexOf('Linux') > -1 || t.platform.indexOf('Linux') > -1) && -1 === t.ua.indexOf('Android')
								)
							},
						},
						{
			...
			function (t, e, i) {
				...
				function o(t, e) {
					...
					for (var r, o = n.length, s = 0; s < o; s++)
						if ((r = e.match(((i = n[s]), new RegExp(i + '[a-zA-Z\\s/:]+([0-9_.]+)', 'i')))) && r.length > 1)
						...
						if (
							...
							if (((e[n] = !0), 'string' == typeof (r = o(t[a], i.ua)))) {
								...
								'edge' === n &&
									...
									(e.version.patch = '0'))
							return (
								'function' == typeof t[a].parseDocumentMode && (e.version.documentMode = t[a].parseDocumentMode()), e
							)
						}
					return e
				}
			...
			function (t, e, i) {
				...
				e.exports = (function t(e, i) {
					...
					if (l.length) c = s(l, Object.assign(i || {}, { modal: !0 }))
						...
						for (var _ in u)
							u.hasOwnProperty(_) && (c = s(u[_], Object.assign(i || {}, { targetElement: e.querySelector('#' + _) })))
					}
					return c
				})()
			},
					...
					(l._bindAnchorForAnalytics = function (t) {
						...
						if (t) {
							...
							;(e = this._createStubPlayer(t)),
								...
								(this.sources[t.id] = { stubPlayer: e, observer: this._createObserver(e) })
						}
					}),
					(l.addSourceObject = l._bindAnchorForAnalytics),
					(l.setCurrentStubPlayer = function () {
						var t,
							e = this.player.el.getAttribute('data-' + this.options.dataAttribute),
					...
					(l._createObserver = function (t) {
						...
						return (
							n &&
								n.observer &&
								n.observer.Video &&
								(e = new n.observer.Video(t, { dataAttribute: this.options.dataAttribute })),
							e
						)
					}),
				...
				e.exports = function (t, e) {
					...
					t.forEach(function (t) {
						t.hasAttribute('data-films-options') &&
							(!1 !== JSON.parse(t.getAttribute('data-films-options')).closeOnEnd ||
								e.closeOnEnd ||
								(e.closeOnEnd = !1))
					...
					var _ = (s =
							!e.modal || (d && p && !e.threesixty) ? (e.modal ? h(m, document.body, e) : u(m, e)) : l(m, e)).play.bind(
							s
						),
						...
						e.appendChild(t.el),
						{
							play: function (i, n, r) {
								...
								s && (n = Object.assign({}, n, JSON.parse(s))),
									t.load(i, null, 0, Object.assign({ maxWidth: window.innerWidth }, n)),
									!1 !== r && t.play()
							},
							player: t,
							destroy: function () {
		...
		121: [
			function (t, e, i) {
				...
				e.exports = function (t, e) {
					...
					var r = n(i)
					return (
						r.modalElement.classList.add('ac-modal-video'), new a({ player: t, modal: r, closeOnEnd: e.closeOnEnd })
					)
				}
			},
			{
		...
		122: [
				...
				var n = /_([0-9]+)x([0-9]+)/,
					...
					s = function (t) {
						;(this.modal = t.modal),
							...
							(this._resizeHandler = new r({ player: this.player, modal: this.modal })),
						...
						;(this._ended = !0),
							!this.player.isPictureInPicture() && this._closeOnEnd
								...
								: this.player.isPictureInPicture() &&
								  ...
								  this._closeOnEnd || (this.modal.open(), this._bindWillClose()))
					}),
					...
					(a.play = function (t, e, i, r) {
						if (((this._ended = !1), this._clearAspectRatio(), t.match('-tft-'))) this._setCinematicMode()
							...
							;(c = { width: s, height: a }),
								o.find(function (t) {
									return (
										(t.width === c.width && (t.height = c.height)) || (t.width === c.height && (t.height = c.width))
									)
								})
									? a > s
										? this._set9X19Mode(!0)
						...
						this.modal.modalElement.setAttribute('aria-label', r),
							this.player.load(t, null, 0, Object.assign({}, e, { maxWidth: window.innerWidth })),
			...
			{ '../../resize/ResizeHandler': 124, '@marcom/ac-video/utils/urlOptimizer/19X9AssetSizes': 381 },
		],
		123: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				;(c._bindMethods = function () {
					...
					(c._onModalOpen = function () {
						this._loadStarted &&
							(this._onResize(), (this._player.el.style.display = ''), (this._player.el.style.opacity = ''))
					}),
					...
					(c._calcAspectRatio = function () {
						;(this._aspectRatio = this._player.getMediaWidth() / this._player.getMediaHeight()),
							(isNaN(this._aspectRatio) || this._aspectRatio <= 0) &&
								...
								(this._aspectRatio = parseInt(RegExp.$1, 10) / parseInt(RegExp.$2, 10)),
							(isNaN(this._aspectRatio) || this._aspectRatio <= 0) &&
								this._posterEl &&
								(this._aspectRatio = this._posterEl.naturalWidth / this._posterEl.naturalHeight),
							this._onResize()
					}),
					...
					(c._onResize = function () {
						...
						if (this._mediaElement.readyState < 1) {
							...
							;(o > i || (a && o > a)) && ((r = (a || i) * t - 2 * c), (o = Math.min(r / t, i))),
						...
						n > t && !this._isFullScreen
							? this._playerContainer.parentElement.classList.add('center-horizontal')
							: this._playerContainer.parentElement.classList.remove('center-horizontal'),
							this._player.refreshSize()
					}),
					(e.exports = a)
			},
			{ '@marcom/feature-detect/touchAvailable': 105, '@marcom/useragent-detect': 110 },
		],
		125: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				function o(t) {
					...
					'undefined' != typeof window
						? ((e = window.requestAnimationFrame), (i = window.cancelAnimationFrame))
						: (e = i = function () {}),
					...
					(n.subscribeImmediate = function (t, e) {
						return (
							...
							this._subscribers[t.id] ||
								(e
									? this._subscribersOrder.splice(this._currentSubscriberIndex + 1, 0, t.id)
						...
						if ('boolean' == typeof t) {
							...
							return (
								t &&
									...
									(this._cancelAnimationFrame.call(window, this._animationFrame), (this._animationFrame = null)),
								!this._willRun ||
									t ||
									this._animationFrame ||
					...
					(n._onAnimationFrame = function (t) {
						for (
							...
							null !== this._subscribers[this._subscribersOrder[this._currentSubscriberIndex]] &&
								...
								this._subscribers[this._subscribersOrder[this._currentSubscriberIndex]]._onAnimationFrameStart(
									this._rafData
								)
						for (
							this.eventEmitter.trigger(this.afterPhaseEventPrefix + this.phase), this._runPhaseIndex = 0;
						...
						for (
							...
							null !== this._subscribers[this._subscribersOrder[this._currentSubscriberIndex]] &&
								!1 === this._subscribers[this._subscribersOrder[this._currentSubscriberIndex]]._didDestroy &&
								this._subscribers[this._subscribersOrder[this._currentSubscriberIndex]]._onAnimationFrameEnd(
									this._rafData
								)
						this.eventEmitter.trigger(this.afterPhaseEventPrefix + this.phase),
		...
		135: [
			...
			{ '../.release-info.js': 127, './RAFExecutor': 129, '@marcom/ac-shared-instance': 239 },
		],
		136: [
			function (t, e, i) {
				'use strict'
				...
				class A extends a {
					constructor(t) {
						super(),
							...
							(this._mapMinValue = void 0 !== t.mapMinValue ? t.mapMinValue : w),
					...
					_update(t) {
						...
						;(this._cachedPos = Object.assign({}, n)),
							...
							this._orientationControls && (this._orientationControls.position = n),
					...
					setPos(t, e) {
						this._pointerControls && (this._pointerControls.position = { lat: t, lon: e }),
							this._orientationControls && (this._orientationControls.position = { lat: t, lon: e }),
					...
					get isAtOrigin() {
						return Math.abs(this.position.lat) <= 0.5 && Math.abs(this.position.lon) <= 0.5
					}
					oscillateLongitude() {
					...
					_respositionCameraToPosition(t, e) {
						if (this._currentTimer)
							return this._currentTimer.cancel().then(() => {
								;(this._currentTimer = null),
									this.setPos(this._tmpCurrentPosition.y, this._tmpCurrentPosition.x),
									(this._tmpCurrentPosition = null),
		...
		139: [
			function (t, e, i) {
				const n = t('./InertialControls'),
					...
					a = { acceleration: { x: 0.6, y: 0.6 }, friction: { x: 0.95, y: 0.95 }, minVelocity: 0.1, maxVelocity: 20 }
				e.exports = class extends n {
					...
					leftArrowDown() {
						Math.abs(this._velocity.x - this._horizontalIncrement) < this._maxVelocity
					...
					upArrowDown(t) {
						Math.abs(this._velocity.y - this._verticalIncrement) < this._maxVelocity
				...
				e.exports = class {
					constructor(t = {}) {
						;(this._horizontalFriction = (t.friction && t.friction.x) || s),
							...
							(this._horizontalIncrement = (t.acceleration && t.acceleration.x) || a),
							(this._verticalIncrement = (t.acceleration && t.acceleration.y) || a),
					...
					_updateInertia() {
						Math.abs(this._velocity.x) > this._minVelocity || Math.abs(this._velocity.y) > this._minVelocity
							...
							: ((this._velocity = { x: 0, y: 0 }), r(this._inertiaRaf), this._inertiaComplete())
					}
					cancelInertia() {
								...
								('function' != typeof DeviceMotionEvent.requestPermission
									...
									: ((this._permissionPromise = DeviceMotionEvent.requestPermission()),
									  this._permissionPromise.catch(t => {
											r("User didn't grant Gyro permission, or request wasn't tied to a user gesture"),
		...
		142: [
			function (t, e, i) {
				const n = t('../utils/normalizeLongitude'),
					...
					o = 135,
					s = 90,
					a = { acceleration: { x: 0.1, y: 0.1 }, friction: { x: 0.95, y: 0.95 }, minVelocity: 0.5, maxVelocity: 20 }
				e.exports = class extends r {
					...
					_addEventListeners() {
						this.el.addEventListener('mousedown', this._onMouseDown),
							this.el.addEventListener('touchstart', this._onMouseDown, { passive: !1 }),
							this.el.addEventListener('click', this._onClick),
							this.el.addEventListener('touchmove', this._onTouchMove, { passive: !1 })
					}
					_removeEventListeners() {
					...
					_onMouseDown(t) {
						...
						;(this._cachedPosition = t),
							...
							document.body.addEventListener('touchmove', this._onTouchMove, { passive: !1 }),
					...
					_onMouseMove(t) {
						...
						if (this._cachedPosition) {
							...
							;(this._velocity.x = Math.max(Math.min(t, this._maxVelocity), -this._maxVelocity)),
								(this._velocity.y = Math.max(Math.min(i, this._maxVelocity), -this._maxVelocity))
						}
				...
				e.exports = class {
					...
					attach() {
						...
						;(this._camera = new THREE.PerspectiveCamera(75, i, 1, 1100)),
							...
							(this._renderer = new THREE.WebGLRenderer({ antialias: !1, powerPreference: o })),
					...
					_tick() {
						this._canvasCtx &&
							this._videoElement &&
							(this._canvasCtx.drawImage(this._videoElement, 0, 0, this._canvas.width, this._canvas.height),
					...
					refreshSize(t, e) {
						this._canvas &&
							((this._canvas.width = THREE.Math.ceilPowerOfTwo(this._videoElement.videoWidth || 1)),
		...
		148: [
			...
			{ '@marcom/ac-raf-emitter/cancelUpdate': 133, '@marcom/ac-raf-emitter/update': 136 },
		],
		149: [
			function (t, e, i) {
				e.exports = function (t, e, i) {
		...
		168: [
			...
			{ './shared/getEventType': 170, './utils/addEventListener': 171, dup: 23 },
		],
		169: [
			function (t, e, i) {
				arguments[4][27][0].apply(i, arguments)
			},
			{ './shared/getEventType': 170, './utils/removeEventListener': 172, dup: 27 },
		],
		170: [
			function (t, e, i) {
		...
		180: [
			...
			{ './DOCUMENT_FRAGMENT_NODE': 174, './internal/isNodeType': 178, dup: 44 },
		],
		181: [
			function (t, e, i) {
		...
		188: [
			...
			{ './Ease': 187, './helpers/KeySpline': 189, '@marcom/ac-polyfills/Array/prototype.every': 217 },
		],
		189: [
			function (t, e, i) {
				e.exports = function (t, e, i, n) {
		...
		194: [
			...
			{ './isDesktop': 193, './isTablet': 196, '@marcom/ac-function/once': 206 },
		],
		195: [
			function (t, e, i) {
				'use strict'
		...
		196: [
			...
			{ './helpers/globals': 192, './isDesktop': 193, '@marcom/ac-function/once': 206 },
		],
		197: [
			function (t, e, i) {
				'use strict'
				...
				n(document, 'fullscreenchange', c),
					...
					(a.exitFullscreen = function (t) {
						...
						t && 'function' == typeof t.webkitExitFullscreen
							...
							: 'function' == typeof document.msExitFullscreen && (e = 'msExitFullscreen'),
					...
					(a.requestFullscreen = function (t) {
						...
						'function' == typeof t.requestFullscreen
							...
							: 'function' == typeof t.msRequestFullscreen && (e = 'msRequestFullscreen'),
		...
		204: [
			function (t, e, i) {
				e.exports = { ENTERFULLSCREEN: 'enterfullscreen', EXITFULLSCREEN: 'exitfullscreen' }
			},
			{},
		],
		205: [
			...
			function (t, e, i) {
				Array.prototype.every ||
					(Array.prototype.every = function (t, e) {
						...
						for (i = 0; i < r; i += 1) if (i in n && !t.call(e, n[i], i, n)) return !1
						return !0
					})
			},
			{},
				...
				t('@marcom/ac-polyfills/performance/now'),
					...
					(n._onSubscribersAnimationFrameStart = function (t) {
						...
						for (e = 0; e < this._subscriberArrayLength; e++)
							null !== this._subscribers[this._subscribersOrder[e]] &&
								...
								this._subscribers[this._subscribersOrder[e]]._onAnimationFrameStart(t)
					}),
					(n._onSubscribersAnimationFrameEnd = function (t) {
						...
						for (e = 0; e < this._subscriberArrayLength; e++)
							null !== this._subscribers[this._subscribersOrder[e]] &&
								!1 === this._subscribers[this._subscribersOrder[e]]._didDestroy &&
								this._subscribers[this._subscribersOrder[e]]._onAnimationFrameEnd(t)
					}),
					(n._onAnimationFrame = function (t) {
						;(this._subscribers = this._nextFrameSubscribers),
							(this._subscribersOrder = this._nextFrameSubscribersOrder),
			...
			function (t, e, i) {
				...
				const n = t('@marcom/ac-event-emitter-micro').EventEmitterMicro,
					...
					d = function (t) {
						...
						for (var e = t.key ? t.key : t.code, i = 0, n = u.length; i < n; i++) if (u[i].string === e) return u[i].num
						return -1
					},
					p = {
						min: 0,
				...
				;(_._addGrabClass = function () {
						...
						this._addEventListener(this.el, 'mousedown', this._onMouseDown),
							...
							this._keyboard &&
								('horizontal' === this.model.orientation
									? (this._keyboard.onDown(l.num, this.stepUp), this._keyboard.onDown(a.num, this.stepDown))
									: (this._keyboard.onDown(h.num, this.stepDown), this._keyboard.onDown(c, this.stepUp)))
					}),
					...
					(_.getClientXValue = function (t, e) {
						var i = this._getClientXFromEvent(t),
							...
							s =
								((i - this.runnableTrackElement.getBoundingClientRect().left - Math.round(n.width / 2)) /
									(o.width - n.width)) *
								100,
					...
					(_._onTouchStart = function (t) {
						...
						this._addEventListener(document, 'touchend', this._onTouchEnd),
							this._addEventListener(document, 'touchmove', this._onTouchMove, { passive: !1 }),
					...
					(_._step = function (t, e) {
						...
						i
							? Math.abs(this._keyDown[d(t)]) < Math.abs(this.model.max * this.model.keyboardMaxStepPercentage) &&
			...
			function (t, e, i) {
				...
				function r() {
					...
					for (t in ((this.types = {}), n))
						n.hasOwnProperty(t) && ((o[t] = t), this.addType(t, n[t].getDialogDebugData.bind(n[t])))
				}
				var o = r.prototype
		...
		252: [
			function (t, e, i) {
				...
				function r() {
					var t
					for (t in ((this.types = {}), n))
						n.hasOwnProperty(t) && ((o[t] = t), this.addType(t, n[t].generateDialog.bind(n[t])))
				}
				var o = r.prototype
				;(o.create = function (t, e) {
					e = e || {}
		...
		254: [
			function (t, e, i) {
				...
				function o() {
					var t
					for (t in ((this.types = {}), n))
						n.hasOwnProperty(t) && ((s[t] = t), this.addType(t, n[t].generateLink.bind(n[t])))
				}
				var s = o.prototype
				;(s.create = function (t, e, i) {
					...
					(s.createFromAnchor = function (t) {
						...
						for (e in n) if (n.hasOwnProperty(e) && i === n[e].id) return void n[e].enhanceLinkEngagement(t)
			...
			{ './NetworkActions': 255, './network-actions/DefaultNetworkAction': 258 },
		],
		255: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				;((n = r.prototype).dataAttributeName = 'network-action'),
					...
					(n.getDialogDebugData = function (t) {
						return { data: this.normalizeData(t), dialogUrl: this.generateLinkURL(t) }
					}),
		...
		265: [
			function (t, e, i) {
				...
				e.exports = new n(
					function (t) {
						return { url: t.url, title: t.title, pics: t.media, summary: t.description }
					},
					{
						id: 'qzone-share',
		...
		272: [
			function (t, e, i) {
				...
				e.exports = new n(
					...
					{ id: 'vk-share', baseLinkPath: 'http://vk.com/share.php', dialogDimensions: { width: 555, height: 368 } }
				)
			},
			{ './NetworkAction': 262 },
		],
			...
			function (t, e, i) {
				...
				e.exports = function (t, e) {
					...
					if (e) {
						...
						var a = n(t)
						for (i = { top: t.offsetTop, right: a.width, bottom: a.height, left: t.offsetLeft }; (t = t.offsetParent); )
					...
					return (
						e
							? ((r = (i = t.getBoundingClientRect()).top),
							  ...
							  (s = i.width),
							  (a = i.height),
							  t.offsetParent && ((r -= (c = t.offsetParent.getBoundingClientRect()).top), (o -= c.left)))
							: ((l = n(t, e)), (r = t.offsetTop), (o = t.offsetLeft), (s = l.width), (a = l.height)),
					...
					return (
						(i = (function (t, e, i) {
							...
							var o,
								s = typeof e
							return (
								(e = 'number' === s || 'string' === s ? { x: e, y: e } : Object.assign(n, e)),
								Object.keys(n).forEach(function (n) {
									var s = e[n]
									;('string' == typeof s || s > 1) &&
										((o = o || r(t, i)), (s = (parseInt(s, 10) || 0) / ('x' === n ? o.width : o.height))),
										(e[n] = s)
								}),
								e
							)
						...
						return (
							...
							n(e, [
								...
								},
								{
									...
									value: function (t) {
										for (
											var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, i = 0;
							...
							n(e, [
								{
									...
									value: function (t, i, n) {
										if (n) {
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'once', this).apply(this, [
												t,
												function () {
													i.apply(n, arguments)
												},
											...
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'once', this).apply(
												this,
												arguments
											)
									},
								},
								{
									...
									value: function (t, i, n) {
										...
										return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'on', this).apply(
											this,
											arguments
										)
									},
								},
								{
									...
									value: function (t, i, n) {
											...
											try {
												for (var o = this._boundListeners[t], s = o.length, a = 0; a < s; a++)
													if (o[a][0] === i && o[a][1] === n) {
														...
														return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'off', this).call(
															this,
															t,
															c[2]
														)
										...
										return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'off', this).apply(
											this,
											arguments
										)
									},
				...
				var R = (function (e) {
					function i(t) {
						...
						return (
							...
							e._isResponsive && (e._breakpointDetect = new L({ el: e.el, player: e, breakpoints: T, addClass: !0 })),
							...
							(t.poster || void 0 === t.poster) &&
								...
								t.autoplay ||
									void 0 === t.preload ||
									('none' !== t.preload && 'metadata' !== t.preload && !1 !== t.preload) ||
									e._poster.show()),
							e._bindMethods(),
							e._addEventListeners(),
							b && (e._keyboardControl = P({ player: e, threesixty: t.threesixty, keyboardTarget: t.keyboardTarget })),
					...
					return (
						...
						o(i, [
							...
							},
							{
								...
								value: function () {
									for (var t = 0, e = A.length; t < e; t++) this._videoImpl.on(A[t], this._forwardEvent)
									for (t = 0, e = O.length; t < e; t++) this._videoImpl.on(O[t], this._forwardReadyStateChange)
									this._videoImpl.on('timeupdate', this._onTimeUpdate),
										...
										b
											? (p.on('enterfullscreen', this._forwardEnterFullScreenEvent),
											  p.on('exitfullscreen', this._forwardExitFullScreenEvent),
											  p.on('enterfullscreen', this._forwardFullScreenChangeEvent),
											  p.on('exitfullscreen', this._forwardFullScreenChangeEvent),
											  this.on('fullscreen:change', this._onFullscreenChange))
											: w &&
											  (this._videoImpl.on('webkitbeginfullscreen', this._forwardEnterFullScreenEvent),
											  ...
											  E && this.on('fullscreen:change', this._onFullscreenChange)),
							...
							},
							{
								...
								value: function () {
									for (var t = 0, e = A.length; t < e; t++) this._videoImpl.off(A[t], this._forwardEvent)
									for (t = 0, e = O.length; t < e; t++) this._videoImpl.off(O[t], this._forwardReadyStateChange)
									this._videoImpl.off('timeupdate', this._onTimeUpdate),
										...
										b
											? (p.off('enterfullscreen', this._forwardEnterFullScreenEvent),
											  p.off('exitfullscreen', this._forwardExitFullScreenEvent),
											  p.off('enterfullscreen', this._forwardFullScreenChangeEvent),
											  p.off('exitfullscreen', this._forwardFullScreenChangeEvent))
											: w &&
											  ...
											  E && this.off('fullscreen:change', this._onFullscreenChange)),
							...
							},
							{
								...
								value: function () {
									...
									;(t > this._cachedReadyState || 0 === t) &&
										((this._cachedReadyState = t), this.trigger('readystatechange', { readyState: t }))
								},
							},
							{
								key: '_forwardEvent',
							...
							},
							{
								...
								value: function () {
									S('play() Promise rejected, probably because the browser is blocking autoplay'),
							...
							},
							{
								...
								value: function (t) {
									...
									i > 0 && this._cachedVisibleCCTrack !== this.getVisibleTextTracks()[0]
										? (this.trigger('texttrackshow'), h.setItem(h.CC_LANGUAGE, this.getVisibleTextTracks()[0].language))
										: 0 === i && this._cachedVisibleTracksLength > 0 && this.trigger('texttrackhide'),
							...
							},
							{
								key: '_onTimeUpdate',
								value: function () {
									this.trigger('timeupdate', { currentTime: this.getCurrentTime() })
								},
							},
							{
								key: 'load',
								value: function (t, e, i, n) {
									if (
										...
										e ||
											(e = t.map(this._urlOptimizer.getCaptionsSource).filter(function (t) {
												return !!t
											}))
									...
									var s =
										(n && n.thumbnails) || (this._urlOptimizer && this._urlOptimizer.getThumbnailImageSource(t[0]))
									this.once('play', this._onPlay),
									...
									this._controlsFactory
										? (this._instantiateDefaultCustomUIControls(),
										  b
												...
												: (this.controls.el.classList.add('mobile'), this.setControls(!0)))
										: this.setControls(!0)
								},
							},
							{
								...
								value: function () {
									this.controls &&
										(this.controls.mainControlsElement
											? this.controls.mainControlsElement.contains(document.activeElement) &&
											  setTimeout(
													function () {
											...
											: this.el.contains(document.activeElement) &&
											  !this.controls.sharingModule.el.contains(document.activeElement) &&
											  setTimeout(
													function () {
														this.controls.playButtonElement.focus()
													}.bind(this)
							...
							},
							{
								...
								value: function () {
									;(this.controls.axListSelector.style.maxHeight =
										'min(' + (this.el.getBoundingClientRect().height - 80) + 'px,250px)'),
										...
										this._isLive
											? (this.el.classList.add('ac-video-live'),
											  e && !C
													...
													: k &&
													  (this._captionRemovalInterval = setInterval(function () {
															t('../utils/removeStateCaptions')(i.getMediaElement())
													  }, 1e4)))
											: (this.el.classList.remove('ac-video-live'), this.el.classList.remove('ac-video-live-dvr'))
								},
							},
							{
								key: 'once',
								value: function (t, e, n) {
									if (arguments.length < 3 || 'object' === (void 0 === n ? 'undefined' : r(n)))
										(function t(e, i, n) {
											null === e && (e = Function.prototype)
											var r = Object.getOwnPropertyDescriptor(e, i)
											if (void 0 === r) {
							...
							},
							{
								...
								value: function () {
									...
									if (i.length)
										for (var n = 0; n < i.length; n++) if (i.start(n) <= t && i.end(n) > t) return (i.end(n) / e) * 100
									return (t / e) * 100
								},
							},
							{
							...
							},
							{
								...
								value: function () {
									this._breakpointDetect
										...
										: (this._currentBreakpoint && this.el.classList.remove(this._currentBreakpoint.name),
										  (this._currentBreakpoint = L.getBreakpointFromElement(this.el, T)),
								...
								value: function () {
									this._removeEventListeners(),
										...
										this._controlsInteraction &&
											(this._controlsInteraction.destroy(), (this._controlsInteraction = null)),
							...
							n(e, [
								{
									...
									value: function () {
										this.get360().requestOrientationControl(),
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'play', this).apply(
												this,
												arguments
											)
									},
								...
								},
								{
									key: '_addEventListeners',
									value: function () {
										r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), '_addEventListeners', this).call(
											this
										)
									},
								},
								{
									key: '_removeEventListeners',
									value: function () {
										r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), '_removeEventListeners', this).call(
											this
										),
								...
								},
								{
									...
									value: function () {
										return (
											!c &&
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'getFullScreenEnabled', this).call(
												this
											)
										)
									},
		...
		301: [
			function (t, e, i) {
				...
				e.exports = function (e) {
					var i
					;(e
						? arguments.length > 1 && (e = Object.assign.apply(null, Array.prototype.slice.apply(arguments)))
						: (e = {}),
					...
					((void 0 !== e.urlOptimizer && !0 === e.urlOptimizer) || 'true' === e.urlOptimizer) &&
					...
					e.threesixty)
						? (e.threesixtyElementsTimeoutDuration || (e.threesixtyElementsTimeoutDuration = 3e3),
					...
					return (
						...
						e.sources &&
							e.sources.length &&
							(e.autoplay || !e.preload || 'auto' === e.preload || !0 === e.preload
						...
						n(t, [
							...
							},
							{
								...
								value: function (t) {
									...
									e !== this._currentSrc &&
										((this._imgElement.style.display = 'none'), (this._imgElement.src = e), (this._currentSrc = e))
								},
							},
							{
								key: '_onLoad',
		...
		305: [
								...
								},
								{
									...
									value: function () {
										...
										t &&
											...
											t.length
												? ((this._activeTrack = t[0]), this._addVideoListeners(this._activeTrack))
												: ((this._activeTrack = null), this._removeVideoListeners()),
			...
			{ './parseVTT': 312, '@marcom/ac-ajax-xhr': 156, '@marcom/ac-function/throttle': 207 },
		],
		306: [
			function (t, e, i) {
				'use strict'
							...
							n(e, [
								{
									...
									value: function (t) {
										;(this._onTrackChange = this._onTrackChange.bind(this)),
											...
											(this._textTrackComponent = o(this.el, l, { video: this._video }))
									},
								},
								{
									key: '_onTrackChange',
								...
								},
								{
									key: 'trigger',
									value: function (t, i) {
										return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'trigger', this).call(
											this,
											t,
											Object.assign({ type: t }, i || {})
										)
									},
								},
								{
		...
		307: [
					...
					if (t instanceof HTMLElement) this.el.appendChild(t)
						...
						;(i.src = t.src),
							...
							'en' === i.srclang
								...
								: (i.label = t.label || (t.srclang && t.srclang.toUpperCase()) || 'Unknown CC'),
							r.browser.firefox
			...
			{ '../dom-emitter/DOMEmitterMicro': 294, '@marcom/useragent-detect': 292 },
		],
		308: [
			function (t, e, i) {
				'use strict'
				...
				e.exports = {
					create: function (t) {
						if (t)
							...
							} else this._textTracksPolyfill = new n({ video: this, tracks: t, container: this._parentElement })
					},
					add: function (t) {
		...
		309: [
			function (t, e, i) {
				...
				e.exports = function (e) {
					var i
					return (
						(i = !!(e = e || {}).hls || (!e.threesixty && (void 0 === e.useNativeCaptions ? r : e.useNativeCaptions))),
						t(i ? './TextTracksNative' : './TextTracksPolyfill')
					)
				}
			},
			{ './TextTracksNative': 307, './TextTracksPolyfill': 308, '@marcom/useragent-detect': 292 },
		],
		310: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				e.exports = function (t) {
					...
					return t.filter(function (t) {
						return (
							!(e.has(t.language) || ('subtitles' !== t.kind && 'captions' !== t.kind && t.kind)) &&
							(e.add(t.language), !0)
						)
					})
				}
			...
			function (t, e, i) {
				...
				e.exports = function (t) {
					for (
						...
						if (((i = ''), o.test(r[a]))) {
							for (
								(e = r[a].split(' --\x3e '))[0] = e[0].split(':').length < 3 ? '00:' + e[0] : e[0],
			...
			function (t, e, i) {
				...
				;(_._initialize = function (t) {
					;(this.el = t.element || document.createElement('div')),
						...
						(this._templateData = t.templateData || Object.assign({ elementClassPrefix: 'controls' })),
						(this._destroyed = !1),
						this._localize().then(
							function () {
								this._destroyed || (this._initUIComponents(t), (this.el.style.display = '')),
					...
					(_._initDesktopControls = function (t, e) {
						this._componentCollection = s(
							...
							p(e, {
									...
									behavior: {
										observe: {
											...
											update: function (t) {
												t.setText(
													r.formatTime(
														this._player.getCurrentTime() - this._player.getDuration(),
								...
								volumeLevel: {
									view: { options: { value: this._player.getMuted() ? 0 : 100 * this._player.getVolume() } },
								},
								playPauseContainer: {
									view: {
										options: {
					...
					(_._initUIComponents = function (t) {
						...
						n &&
							(t.enableMainControls
								? (n.classList.add('control-bar-skin-default'), (this.mainControlsElement = n))
								: n.parentElement.removeChild(n))
						var r = e.querySelector('.end-state-container')
						r && (this.endState = new h(Object.assign({}, { el: r, player: this._player }, t.endState))),
							t.threesixty && (this.compass = new u({ rootElement: e, player: this._player })),
		...
		316: [
			function (t, e, i) {
				...
				e.exports = {
					back30Seconds: { className: 'back-30-seconds-button', view: { classDef: n } },
					gotoLive: {
						...
						view: {
							...
							options: {
								...
								labels: { initial: 'livestream', on: 'livestream', off: 'livestream' },
							},
						},
						behavior: { classDef: w },
					},
					fullScreen: {
						...
						view: {
							classDef: o,
							options: {
								states: { initial: 'fullscreen-unsupported', on: 'is-fullscreen', off: '' },
								labels: { initial: 'fullscreen', on: 'exitfullscreen', off: 'fullscreen' },
							},
						},
						behavior: { classDef: _ },
					},
					toggleMuteVolume: {
						...
						view: { classDef: o, options: { states: { initial: [], on: ['is-muted'], off: [] } } },
						behavior: { classDef: h },
					},
					playPauseContainer: {
						className: 'play-pause-button-container',
						view: { classDef: r, options: { states: { playing: ['is-playing'], paused: [], ended: ['is-ended'] } } },
						behavior: { classDef: u },
					},
					pictureInPictureToggle: {
						...
						view: {
							classDef: o,
							options: {
								states: { initial: ['picture-in-picture-unsupported'], on: ['is-picture-in-picture'], off: [] },
								labels: { initial: 'pictureinpicture', on: 'exitpictureinpicture', off: 'pictureinpicture' },
							},
						},
						behavior: { classDef: d },
					},
					captionsToggle: {
						...
						view: {
							classDef: o,
							options: { states: { initial: ['no-text-tracks'], on: ['text-tracks-visible'], off: [] } },
						},
						behavior: { classDef: p },
					},
					audioTracksSelector: { className: 'audio-selector', view: { classDef: a }, behavior: { classDef: m } },
					captionsSelector: { className: 'captions-selector', view: { classDef: a }, behavior: { classDef: f } },
					airplayToggle: {
						className: 'airplay-button',
						view: {
							classDef: o,
							options: { states: { initial: ['airplay-unsupported'], on: ['airplay-active'], off: [] } },
						},
						behavior: { classDef: E },
					},
					elapsedTimeIndicator: { className: 'elapsed-time', view: { classDef: s } },
					remainingTimeIndicator: { className: 'remaining-time', view: { classDef: s } },
					progressBar: {
						className: 'progress-indicator',
						view: { classDef: c, options: { template: x, min: 0, max: 1, mixins: [k], orientation: 'horizontal' } },
						behavior: { classDef: v },
					},
					volumeLevel: {
						className: 'volume-level-indicator',
						view: { classDef: c, options: { template: C, min: 0, max: 100, mixins: [k], orientation: 'vertical' } },
						behavior: { classDef: y },
					},
					sharing: {
						...
						view: {
							classDef: r,
							options: { states: { initial: ['sharing-unsupported'], on: ['is-sharing'], off: [] } },
						},
						behavior: { classDef: g },
					},
					socialShare: { className: 'social-tray', view: { classDef: l, options: {} }, behavior: { classDef: b } },
				}
			},
			{
						...
						function e(t, i) {
							...
							return (
								n._player.supportsAirPlay() &&
									...
									n._player
										.getMediaElement()
										.addEventListener('webkitplaybacktargetavailabilitychanged', n._airplayStateChange),
									(n._updateState = n._updateState.bind(n)),
									n._player
										.getMediaElement()
										.addEventListener('webkitcurrentplaybacktargetiswirelesschanged', n._updateState)),
								n
							)
						}
						return (
							...
							n(e, [
								...
								},
								{
									...
									value: function () {
										this._player
											.getMediaElement()
											.removeEventListener('webkitplaybacktargetavailabilitychanged', this._airplayStateChange),
											this._player
												.getMediaElement()
												.removeEventListener('webkitcurrentplaybacktargetiswirelesschanged', this._updateState),
											(function t(e, i, n) {
												null === e && (e = Function.prototype)
												var r = Object.getOwnPropertyDescriptor(e, i)
												if (void 0 === r) {
											...
											a ||
												(a =
													'description' === t.kind
														...
														? o[t.language]
														: t.language)
											var c = { enabled: e, id: i, kind: n, label: a, language: r }
											return (
				...
				var r = t('./ButtonBehavior'),
					...
					l = (function (t) {
						function e(t, i) {
							...
							return (
								n._updateState(), (n._allowMultiLanguageCaptions = !n._player.options.disableMultiLanguageCaptions), n
							)
						}
						return (
							(function (t, e) {
							...
							n(e, [
								...
								},
								{
									...
									value: function () {
										...
										;(e.length > 1 && this._allowMultiLanguageCaptions) || i.length > 1
											...
											i = h(this._player.getTextTracks()).map(function (i) {
												...
												var s = {
													label:
														...
														i.label ||
														i.language ||
														(i.srclang && ('en' === i.srclang.toLowerCase() ? 'English' : i.srclang)) ||
														'Unknown CC',
													language: i.language,
												}
												return (
								...
								},
								{
									...
									value: function (t) {
										...
										this._player.getVisibleTextTracks().forEach(function (t) {
											...
											e.language !== r ? ((e.enabled = !0), d.removeItem('cc-disabled')) : d.setItem('cc-disabled', !0),
							...
							n(e, [
								{
									key: '_updateState',
									value: function () {
										this._player.getDuration() - this._player.getCurrentTime() < o
											? this._view.setState('on')
											: this._view.setState('off')
									},
								},
								...
								},
								{
									...
									value: function () {
										this._player.getMuted()
											? (this._player.setMuted(!1), 0 === this._player.getVolume() && this._player.setVolume(0.1))
								...
								},
								{
									...
									value: function () {
										this._player.getEnded()
											...
											: this._view.setState(this._player.getPaused() ? 'paused' : 'playing')
									},
								},
								{
									key: '_togglePlay',
				...
				var r = t('./BaseBehavior'),
					...
					l = (function (t) {
						function e(t, i) {
							...
							return (
								n._player.isDvr() ? (n._liveStreamLookback = c) : (n._liveStreamLookback = 0),
								(n._visible = !1),
								...
								},
								{
									...
									value: function () {
										this._setIsPlaying(!0),
											this._player.isLive() || (a(this._timeUpdateInterval), (this._raf = s(this._onRAF)))
									},
								},
								{
									key: '_onRAF',
									...
									value: function () {
										this._stateChanging ||
											('sharing' === this._player.states.getCurrentState()
												? (this._view.setState('off'), this._player.states.setState('none'))
												: (this._view.setState('on'), this._player.states.setState('sharing')),
							...
							n(e, [
								{
									key: '_updateState',
									value: function () {
										;(this.sharingModule = new o(Object.assign({}, { player: this._player, parentView: this._view }))),
						...
						return (
							...
							n(e, [
								...
								},
								{
									...
									value: function (t) {
										t
											? (this._player.setMuted(!1), this._player.setVolume(t / 100))
											: (this._player.setMuted(!0), this._player.setVolume(this._cachedVolume))
									},
								},
								{
									key: '_showVolume',
		...
		332: [
						...
						function e(t) {
							...
							return (
								...
								(i._span.innerText = c(r, {
									...
									chaptertime: c(l.getTranslation().currenttimetext, { minutes: u, seconds: d }),
								})),
			...
			{ '../localization/Localization': 358, '@marcom/ac-event-emitter-micro': 190, '@marcom/ac-string/supplant': 275 },
		],
		333: [
			function (t, e, i) {
				'use strict'
								...
								},
								{
									...
									value: function () {
										this._player.once(
											...
											function () {
												s ||
													(this.compass.addEventListener('mouseenter', this._onCompassMouseEnter),
									...
									value: function (t) {
										this._compassIsRotating ||
											(this._player.get360().isAtOrigin
												? (this._360.on(a.ROTATION_UPDATE, this._on360IconUpdate),
									...
									value: function () {
										...
										;(this.compassField.style.transition = 'transform 0.3s ease'),
											(this.compassField.style.transform =
												t > 180 ? 'rotate(360deg)' : t < -180 ? 'rotate(-360deg)' : 'rotate(0deg)')
									},
								},
								{
			...
			{ '@marcom/ac-360': 138, '@marcom/ac-keyboard/Keyboard': 208, '@marcom/useragent-detect': 292 },
		],
		334: [
			function (t, e, i) {
				'use strict'
								...
								value: function () {
									this._controls.el.addEventListener('mousemove', this._onUserInteraction, !0),
										...
										'onmouseleave' in this.el
											? this._controls.el.addEventListener('mouseleave', this._onMouseLeave)
											: this._controls.el.addEventListener('mouseout', this._onMouseOut, !0),
							...
							},
							{
								...
								value: function () {
									this._controls.el.removeEventListener('mousemove', this._onUserInteraction, !0),
										...
										'onmouseleave' in this.el
											? this._controls.el.removeEventListener('mouseleave', this._onMouseLeave)
											: this._controls.el.removeEventListener('mouseout', this._onMouseOut, !0),
							...
							},
							{
								...
								value: function (t, e) {
									!t ||
										...
										(this._player.isCaptionsSelectorShowing() &&
											!t.target.classList.contains('controls-text-tracks-toggle-button') &&
										...
										!this._player.getCurrentSrc() ||
											...
											(t && t.pageX && (this._lastMouseCoords = { x: t.screenX, y: t.screenY }),
											this._showControls(),
											this._raiseControls(),
								...
								value: function (t) {
									...
									this._focusOutTimer = setTimeout(function () {
										e._hasFocus &&
											...
											((e._hasFocus = !1), e._hideControls(), e._lowerControls())
									}, 100)
								},
							},
							{
						...
						return (
							...
							n(e, [
								...
								},
								{
									...
									value: function (t) {
										this._userWasRecentlyDragging ||
											...
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), '_onUserInteraction', this).call(
												this
											))
									},
								},
								...
								},
								{
									...
									value: function (t) {
										return (
											-1 !== [this._player.controls.compass.el, this._player.controls.playButtonElement].indexOf(t) ||
								...
								},
								{
									key: '_onMouseDown',
									value: function (t) {
										;(this._isActiveArea(t.target) && this._controlsVisible() && !this._isDraggable(t.target)) ||
								...
								},
								{
									...
									value: function (t) {
										this._player.controls.compass.el.contains(t.target) &&
											this._userWasRecentlyDragging &&
											t.stopPropagation(),
											(t.target !== this._player.controls.playButtonElement.parentElement &&
								...
								},
								{
									...
									value: function () {
										return (
											!this._player.controls.el.classList.contains('start-state') &&
						...
						return (
							...
							n(e, [
								...
								},
								{
									key: '_addEventListeners',
									value: function () {
										this._controls.el.addEventListener('touchstart', this._onTouchStart, { passive: !1 }),
											this._controls.el.addEventListener('click', this._onClick),
									...
									value: function (t) {
										t.target !== this._player.controls.compass.compassView &&
											(this._controlsVisible()
												? this._isActiveArea(t.target) || (this._hideControls(), this._hideCompass())
												: this._onUserInteraction(t))
									},
								},
								{
												...
												n.setAttribute('role', 'radio'),
													t.enabled
														? (n.classList.add('enabled'),
														  ...
														  (i = n))
														: (n.setAttribute('aria-checked', 'false'), n.setAttribute('tabIndex', -1)),
													(n.innerText = t.label),
													(n.acvMetadata = t),
													e.el.appendChild(n)
											}),
								...
								},
								{
									...
									value: function (t) {
										...
										parseInt(t.keyCode) === s.ARROW_DOWN
											? (i = e.nextSibling)
											: parseInt(t.keyCode) === s.ARROW_UP && (i = e.previousSibling),
											i && (this.trigger('ItemSelected', i.acvMetadata), t.preventDefault(), t.stopPropagation())
									},
								},
								{
									key: '_onClick',
				...
				var n = t('@marcom/ac-slider').Slider,
					...
					o = function (t, e) {
						...
						;(this._slider = new n(this.el, {
							...
							this._notchEl &&
								(this._slider.el.addEventListener('mouseover', this._onMouseOver),
							...
							n(e, [
								{
									...
									value: function (t) {
										this._currentState &&
											...
											this.el.classList.remove(this._states[this._currentState]),
											(this._currentState = t),
											this._labels &&
												this._labels[this._currentState] &&
												((this._focusTarget.value = this._labels[this._currentState]),
					...
					if ('link' === t.type || 'video' === t.type) {
						...
						e.classList.remove('hidden'),
							...
							'link' === t.type
								...
								: 'video' === t.type && e.classList.add('icon', 'icon-after', 'icon-playcircle'),
			...
			function (t, e, i) {
				...
				;(o._addItems = function (t) {
					...
					(o.setData = function (t) {
						...
						;(this.el.innerHTML = ''),
							t ? (this.el.classList.remove('hidden'), this._addItems(t.items)) : this.el.classList.add('hidden')
					}),
					(o.destroy = function () {
						for (; this._items.length; ) this._items.pop().destroy()
					}),
		...
		352: [
				...
				;(d._bindMethods = function () {
					...
					(d._onSpaceBarDown = function (t) {
						'BUTTON' !== t.target.tagName &&
							...
							(this._keyboard.offDown(o, this._onSpaceBarDown), this._keyboard.onUp(o, this._onSpaceBarUp))
					}),
			...
			{ '@marcom/ac-event-emitter-micro': 190, '@marcom/ac-keyboard/Keyboard': 208 },
		],
		353: [
			function (t, e, i) {
				'use strict'
								...
								},
								{
									...
									value: function (t) {
										t.target.classList.contains('controls-progress-indicator')
											? this._triggerKeyboardInteraction()
											: (t.originalEvent.preventDefault(), this._arrowControls.leftArrowUp(t))
									},
								},
								{
									key: '_onRightArrowUp',
									value: function (t) {
										t.target.classList.contains('controls-progress-indicator')
											? this._triggerKeyboardInteraction()
											: (t.originalEvent.preventDefault(), this._arrowControls.rightArrowUp(t))
									},
								},
								{
									key: '_onUpArrowUp',
									...
									value: function () {
										this._player.off('waiting', this.show),
											...
											this._player.controls &&
												this._player.controls.el.removeEventListener('mouseout', this._onMouseOut)
									},
								},
								{
									key: '_onPause',
										...
										this._isPaused ||
											(!0 !== t && this._started
												? (clearTimeout(this._showTimeout),
												  (this._showTimeout = setTimeout(this._doShow, this._showTimeoutDelay)))
												: this._doShow())
									},
								},
								{
									...
									value: function (t) {
										!this._player.getEnded() && this._started && (this._player.isStalled() || this._isSeeking)
											? this.show(!0 === t)
											: this.hide()
									},
								},
		...
		358: [
			...
			{ './DefaultLabelStrings': 356, './Translations': 359, '@marcom/ac-ajax-xhr': 156 },
		],
		359: [
			function (t, e, i) {
				'use strict'
			...
			function (t, e, i) {
				...
				;(l._initPointerTracking = function () {
					;(this._scrubberView = this._player.controls.scrubberView),
						this._scrubberView &&
							((this._runnableTrack = this._scrubberView.el.querySelector('.ac-slider-runnable-track')),
							this._calcOffsets(),
					...
					(l._onLoadedMetaData = function () {
						...
						this.el.classList.remove('square-video'),
							...
							i
								? (this.el.classList.add('tft-video'), this._thumbnailHandler.setVertical(!1))
								: t < e
								? (this.el.classList.add('vertical-video'), this._thumbnailHandler.setVertical(!0))
								: t === e
								? (this.el.classList.add('square-video'), this._thumbnailHandler.setVertical(!1))
						...
						;(this.el.style.opacity = '0'),
							...
							t && this._player.getReadyState() > 2
								...
								: (this._thumbnailHandler.setData(null),
								  t
										? ((this._canPlayThroughHander = this.setData.bind(this, t)),
			...
			function (t, e, i) {
				...
				;(r.setVertical = function (t) {
							...
							var e = this._loadImage(this._imgUrl).then(
								function () {
									this._imageLoadPromise === e &&
										((this.el.style.backgroundImage = 'url("' + this._imgUrl + '")'),
					...
					(r.setTime = function (t, e) {
						var i = t / e,
							n =
								(Math.min(Math.round(i * this._numberOfImages), this._numberOfImages - 1) /
			...
			function (t, e, i) {
				...
				;(f._initializeElement = function (t, e) {
					...
					(f.setData = function (t) {
						if (t) {
							if (
								...
								(this._hideLine = void 0 === t.hideLineShare || t.hideLineShare),
								...
								try {
									this._initAnalyticsAttributes(t),
										this._analyticsObserver || (this._analyticsObserver = h({ context: this.el }))
								} catch (t) {
									o("ac-analytics-share failed to load, are you sure you've included it?")
								}
					...
					(f._focusFirstButton = function () {
						this._firstButton || (this._firstButton = l.getTabbableElements(this._sharingButtonContainer)[0]),
					...
					(f._initAnalyticsAttributes = function (t) {
						var e = []
						this._facebookButton && e.push({ button: this._facebookButton, title: 'facebook', events: 'event85' }),
							...
							this._copyEmbedCodeButton &&
								e.push({ button: this._copyEmbedCodeButton, title: 'copy-embed-code', events: 'event101' })
				...
				;(s.constructor = r),
					...
					(s._onResize = function (t) {
						...
						if ((!1 !== t && this._player.refreshSize(), !i || !r.widthInBreakpoint(e, i))) {
							...
							this._addClasses &&
								(this._currentBreakpoint && this.el.classList.remove(i.name), this.el.classList.add(n.name)),
				...
				var n = t('@marcom/ac-string/supplant'),
					r = {
						addLeadingZero: function (t, e) {
							if (((e = e || 2), t < 10 || e > 2)) for (t = String(t); t.length < e; ) t = '0' + t
							return t
						},
					...
					for (var s in o)
						o.hasOwnProperty(s) &&
							(i.hasOwnProperty(s) && 'object' === n(i[s])
								? 'object' === n(i[s]) && 'object' === n(o[s]) && (i[s] = t(i[s], o[s]))
								: (i[s] = o[s]))
				...
				e.exports = function (t) {
					...
					try {
						for (var r, o = Array.from(t.textTracks)[Symbol.iterator](); !(e = (r = o.next()).done); e = !0)
							for (var s = r.value; s.cues && s.cues.length && s.cues[0].endTime < t.currentTime - 60; )
			...
			function (t, e, i) {
				...
				e.exports = {
					getVideoSource: function (t, e, i, a) {
						...
						var v,
							y = {}
						if (((y.width = parseInt(RegExp.$1, 10)), (y.height = parseInt(RegExp.$2, 10)), t.match(u)))
							(l = f), (h = 1536)
						...
						return (
							...
							t.match(k) ? t.replace(k, n(w, g)) : t.match(r) ? t.replace(r, n(w, g)) : t
						)
					},
				...
				var o = window.Hls,
					...
					u = (function (t) {
						function e(t) {
							...
							return (
								(i._src = null), (i._hlsUrl = t.hlsUrl || c), (i._hlsConfig = t.hlsConfig || {}), i._initialize(t), i
							)
						}
						return (
							(function (t, e) {
							...
							n(e, [
									...
									value: function (t, e) {
										...
										if (o) {
											this._initHls(),
												...
												this._hls.on(o.Events.AUDIO_TRACK_SWITCHED, function (t, e) {
													;(i.audioTrackEventObj = e), i._forwardAudioTrackChangeEvent()
												}),
												(this._src = t[0])
											var n = function () {
											...
											this._hls.on(o.Events.MEDIA_ATTACHED, n), this._hls.attachMedia(this.el)
								...
								},
								{
									key: 'getCurrentTime',
									value: function () {
										var t = r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'getCurrentTime', this).call(
											this
										)
										return t < 0.1 ? 0 : t
									},
								...
								},
								{
									...
									value: function (t) {
										return 'vnd.apple.mpegURL' === t
											? r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'canPlayType', this).call(
													this,
													'video/mp4'
											  )
											: r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'canPlayType', this).call(
								...
								},
								{
									...
									value: function () {
										this._hls && void 0 !== this._hls.desiredRate && (this._hls.desiredRate = 0),
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), '_playPromiseRejected', this).call(
												this
											)
									},
								},
								...
								},
								{
									...
									value: function () {
											...
											return this._hls.audioTracks.map(function (e, r) {
												...
												return (
													Object.defineProperty(o, 'enabled', {
														...
														set: function (t) {
															t && (i.audioSelectedPersistentID = e.persistentID)
														},
													}),
													o
												)
										...
										return r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'getAudioTracks', this).call(
											this
										)
									},
								},
								{
									...
									value: function () {
										this.off('play', this._onPlay),
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'destroy', this).call(this),
											this._hls &&
												(this._hls.off(o.Events.AUDIO_TRACK_SWITCHED, this._forwardAudioTrackChangeEvent),
												this._hls.off(o.Events.AUDIO_TRACKS_UPDATED, this._forwardAudioTrackChangeEvent),
												this._hls.destroy(),
												(this._hls = null))
									},
								},
								...
								},
								{
									...
									value: function () {
										return this._hls && void 0 !== this._hls.desiredRate
											...
											: r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'getPaused', this).call(this)
									},
								},
								{
									key: 'isStalled',
									value: function () {
										return (
											...
											r(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), 'isStalled', this).call(this)
										)
									},
								},
								{
					...
					l = (function (t) {
						function e(t) {
							...
							return (
								...
								(n._textTracks = o(t)),
								n._initElement(),
								(n._forwardAudioTrackChangeEvent = n._forwardAudioTrackChangeEvent.bind(n)),
								...
								n.el.audioTracks &&
									(n.el.audioTracks.addEventListener('addtrack', n._forwardAudioTrackChangeEvent),
						...
						return (
							...
							n(e, [
										...
										this.el.classList.add('ac-video-media-controller'),
											null !== this.options.crossorigin &&
												this.el.setAttribute(
													'crossorigin',
													this.options.crossorigin ? this.options.crossorigin : 'anonymous'
												),
									...
									value: function () {
										...
										if (this._cachedVisibleTracks) {
											if (!this._cachedVisibleTracks.length) {
												...
												try {
													for (
														var r, o = Array.from(this.el.textTracks)[Symbol.iterator]();
														!(e = (r = o.next()).done);
														e = !0
													) {
														r.value.mode = 'hidden'
								...
								},
								{
									...
									value: function (t) {
										t
											? (this.el.setAttribute('controls', ''), this.el.removeAttribute('aria-hidden'))
											: (this.el.removeAttribute('controls'), this.el.setAttribute('aria-hidden', 'true'))
									},
								},
								{
									key: 'isFullscreen',
								...
								},
								{
									...
									value: function (t) {
										this.supportsPictureInPicture() &&
											this.el.webkitSetPresentationMode(t ? 'picture-in-picture' : 'inline')
									},
								},
								{
									key: 'supportsAirPlay',
									...
									value: function () {
										;(this._playPromise = null),
											this._textTracksEmitter &&
												(this._textTracksEmitter.off('addtrack', this._forwardCaptionEvent),
		...
		386: [
			function (t, e, i) {
				...
				try {
					for (
						var l, h = Object.getOwnPropertyNames(r.prototype)[Symbol.iterator]();
						!(s = (l = h.next()).done);
						s = !0
					) {
						var u = l.value
						...
						return (
							n(t, [
								...
								},
								{
									key: '_init360',
									value: function () {
										;(this._ac360 = new r({ el: this._renderElement, src: this.getMediaElement() })),
											this._ac360.on(
												'error',
												function () {
								...
								},
								{
									...
									value: function () {
										this._ac360
											? (this._ac360.setPos(0, 0), this._super.load.apply(this, arguments))
						...
						(t.hls ||
							(function (t) {
								return (
									...
									(t.sources && t.sources[0] && -1 !== t.sources[0].indexOf('.m3u8'))
								)
							})(t)) &&
						...
						n(t, [
							{
								key: 'create',
								value: function (t, e) {
									if (u(t) && !t.threesixty) return new r(Object.assign({}, t, { parentElement: e }))
									if (t.threesixty) {
										var i = o
										return u(t) && (i = s), new i(Object.assign({}, t, { parentElement: e }))
									}
